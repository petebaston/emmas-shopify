...
(function (Flits) {
    ...
    var deliveryAddress = (Flits.deliveryAddress = function (options) {
        ...
        if (
            ...
            (Flits.deliveryAddress.settings.totalAddress = parseInt(Flits("div[data-address-count]").attr("data-address-count") - Flits("div[flits-ship-address-unavailable-count]").attr("flits-ship-address-unavailable-count") )),// here we minus not available custom shipping address
            ...
            Flits.deliveryAddress.settings.totalAddress == 0 ? (Flits(".flits-address-pagination-loader").hide(),Flits(".flits-address-empty").removeClass('flits-d-none')) : Flits.deliveryAddress.settings.totalAddress >= 2 && Flits(".flits-address-list-pagination-row").addClass("flits-hr"),// also we have added here if order is not availabel then showing empty code
            setPagination(),
